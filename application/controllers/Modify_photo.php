...
class Modify_photo extends CI_Controller {
	...
	public function index()
	{
		...
		$this->common_model->extra_css_fr= array('css/mdb.min.css','css/hover-img.css','css/bootstrap-touch-slider.css','css/chosen.css','css/BootSideMenu.css','css/canvasCrop.css?ver=1');
		$this->common_model->extra_js_fr= array('js/BootSideMenu.js','js/chosen.jquery.js','js/jquery.validate.min.js','js/photo_protect_js.js','js/jquery.canvasCrop.js');
