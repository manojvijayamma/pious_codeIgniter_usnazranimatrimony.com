...
class Wedding_vendor extends CI_Controller {
	...
	{	
		...
		if($is_ajax == 0)
		{	
			$this->common_model->extra_css_fr= array('css/fontello.css','css/jquery-ui.css');
	...
	{	
		...
		{	
			...
			{
				$this->common_model->extra_css_fr= array('css/owl.carousel.css','css/fontello.css','css/jquery-ui.css','css/zebra_datepicker.min.css');	
				$this->common_model->extra_js_fr= array('js/owl.carousel.min.js','js/slider.js','js/jquery.gmaps.min.js','js/zebra_datepicker.min.js');
