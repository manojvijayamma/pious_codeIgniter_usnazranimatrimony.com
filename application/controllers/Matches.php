...
class Matches extends CI_Controller {
	...
	{	
		...
		$this->common_model->extra_css_fr= array('css/hover-img.css','css/mdb.min.css','css/bootstrap-touch-slider.css','css/BootSideMenu.css','css/select2.min.css');
		$this->common_model->extra_js_fr= array('js/select2.min.js','js/BootSideMenu.js','js/editor.js','js/jquery.validate.min.js','js/photo_protect_js.js');
	...
	public function received_match_from_admin($page=1)
	{
		...
		if($user_agent!='NI-WEB')
		{
			...
			{
				$this->common_model->display_top_menu_perm ='No';
				$this->common_model->extra_css_fr= array('css/hover-img.css','css/mdb.min.css','css/bootstrap-touch-slider.css','css/BootSideMenu.css','css/select2.min.css','css/chosen.css');
				$this->common_model->extra_js_fr= array('js/select2.min.js','js/chosen.jquery.js','js/BootSideMenu.js','js/editor.js','js/jquery.validate.min.js','js/photo_protect_js.js');
