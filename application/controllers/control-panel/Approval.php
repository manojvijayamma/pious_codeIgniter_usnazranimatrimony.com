...
class Approval extends CI_Controller {
	...
	public function success_story($status ='ALL', $page =1)
	{
		...
		$other_config = array('load_member'=>'yes','data_table_mem'=>$data_table,'default_order'=>'desc','enctype'=>'enctype="multipart/form-data"','display_image'=>'weddingphoto','weddingphoto'=>$this->common_model->path_success,'field_duplicate'=>array('brideid','groomid')); 
