...
RewriteRule ^(.*\.(gif|jp?g|png))$ ".base_url()."assets/photos_big/watermark.php?image=$1 [NC] ";
	...
	public function social_site_setting($status ='')
	{
		...
		else
		{
			$ele_array = array(
				...
				'youtube_link'=>array('input_type'=>'url'),
				'pinterest_link'=>array('input_type'=>'url'),
				'instagram_link'=>array('input_type'=>'url')
	...
	public function homepage_text($status ='')
	{
		...
		{
			$ele_array = array(
				'homepage_banner_text'=>array('type'=>'textarea','is_required'=>'required'),
				'homepage_banner_description'=>array('type'=>'textarea'),
				'middle_text1'=>array('is_required'=>'required'),
				'middle_text1_description'=>array('type'=>'textarea'),
				'middle_text2'=>array('is_required'=>'required'),
				'middle_text2_description'=>array('type'=>'textarea'),
