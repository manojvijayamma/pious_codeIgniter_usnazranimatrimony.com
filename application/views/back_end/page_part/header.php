		...
		<div class="sidebar-panel offscreen-left">
    		...
    		<nav role="navigation">
      			<ul class="nav">
                    ...
                    <li id="site_setting">
                    	<a href=javascript:;> <i class="fa fa-cogs"></i> <span>Site Settings</span> </a>
      					<ul class=sub-menu>
                            ...
                            <li id="seo_pages"><a href="<?php echo $base_url.$admin_path.'/site-setting/seo-pages/ALL/1/yes';?>"> <span>Seo Page Data</span> </a></li>
                    ...
                    <li id="new_listing">
                    	<a href=javascript:;> <i class="fa fa-plus"></i> <span>Add New Details</span> </a>
          				<ul class=sub-menu>
							...
							<li class="new_listing_add" id="other_banner">
                            	<a href="<?php echo $base_url.$admin_path.'/new-listing/other_banner';?>"> <span>Other Banner</span> </a> 
                            </li>
							<li class="new_listing_add" id="reason_why_choose">
                            	<a href="<?php echo $base_url.$admin_path.'/new-listing/reason_why_choose/ALL/1/yes';?>"> <span>Reason Why Choose</span> </a> 
                            </li>
                    ...
                    <?php
						if($base_url =='http://192.168.1.111/mega_matrimony/original_script/v1.0/')
						{
					?>
