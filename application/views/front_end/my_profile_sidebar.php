...
<div class="row">
   ...
   <div class="xxl-16 xl-16 m-16 l-16 xs-16 s-16 bg-white compltele-profile margin-bottom-15px hidden-sm hidden-xs" style="padding-top:0px;">
	...
	<div class="collapse in xxl-16 xl-16 l-16 m-16 s-16 xs-16 bg-white" style="box-shadow: none;" id="ne_Messages" >
    <div class="row">
        <?php
    ...
    <div class="row" style="padding:4px;">
		...
		<a href="javascript:;" onclick="change_img('quick_search')">
			<div class="row upgrade-heading"  data-toggle="collapse" href="#ne_quick_search" aria-expanded="false" aria-controls="ne_quick_search" style="padding:4px;">
        ...
        <div class="collapse in xxl-16 xl-16 m-16 s-16 l-16xs-16 ne_myhome_save_search"  id="ne_quick_search" >
            <div class="row">
    ...
    <div class="clearfix"></div>
    <!----for advertisement------>
    <div class="xxl-16 xl-16 m-16 l-16 xs-16 s-16 compltele-profile margin-bottom-15px hidden-sm hidden-xs" style="padding:4px;">
