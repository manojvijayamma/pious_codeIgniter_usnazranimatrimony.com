							...
							<form id="ne_lft_pan_list3" name="ne_lft_pan_list3" action="<?php echo $base_url; ?>my-profile/save-profile/religious-detail" onSubmit="return validat_function('ne_lft_pan_list3')" class="collapse margin-top-10 religious-detail">
								...
								<?php
									...
									$ele_array = array(
               						...
               						'religion'=>array('is_required'=>'required','type'=>'dropdown','onchange'=>"dropdownChange('religion','caste','caste_list')",'value_arr'=>$religion_arr,'extra_style'=>'width:100%','label'=>'Community'),
								...
								<form id="ne_lft_pan_list4" name="ne_lft_pan_list4" action="<?php echo $base_url; ?>my-profile/save-profile/residence-detail" onSubmit="return validat_function_res()" class="collapse margin-top-10 residence-detail">
									...
									<?php		
...

										{
											...
											<input type="text" minlength="7"  maxlength="15" required name="mobile_num" id="mobile_num" class="form-control" placeholder="Mobile Number" value ="'.$mobile_val.'"  />
										...
										'city'=>array('type'=>'dropdown','relation'=>array('rel_table'=>'city_master','key_val'=>'id','key_disp'=>'city_name','not_load_add'=>'yes','cus_rel_col_name'=>'state_id'),'label'=>'City','class'=>'select2','extra_style'=>'width:100%'),
