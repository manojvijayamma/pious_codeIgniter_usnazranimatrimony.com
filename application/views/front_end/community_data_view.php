...
<div class="xs-16 xl-16 xxl-16 m-16 s-16 ne_result padding-lr-zero margin-bottom-10px margin-top-10">
    ...
    <div class="xxl-12 xl-12 l-12 m-11 s-16 xs-16 padding-lr-zero-1199 padding-lr-zero-999 padding-lr-zero-768">
        ...
        <div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 margin-top-5">
            <div class="row">
				...
				?><a target="_blank" href="<?php echo base_url()."search/view-profile/".$member_data_val['matri_id']; ?>">Read More</a> <img src="<?php echo $base_url; ?>assets/front_end/images/icon/view-arrow.gif" alt="view-arrow" /></p>
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    ...
    <div style="text-align: center">
        <a class="underline hook1 in" data-toggle="collapse" href=".<?php echo $member_data_val['matri_id'];?>" aria-expanded="false">More Details <i class="fa fa-chevron-down"></i></a>
    </div>
