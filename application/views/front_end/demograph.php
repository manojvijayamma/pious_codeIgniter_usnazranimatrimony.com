				...
				<div class="panel panel-primary"><!-- panel panel-primary -->
					...
					<div class="panel-body">
						<form method="post" id="myForm">
                            ...
                            <?php /*?>
							<!--<div id="show_response_country">
								<div data-delay="300" class="xs-16 xxl-10 xl-10 l-10 m-16 s-16  margin-top-5px  animated">
									<div class="panel panel-primary">
										<div class="panel-heading">
											<h3  class="panel-title text-center">SELECT COUNTRY</h3>
										</div>
										<div class="panel-body">
											<div class="table-responsive">
												<table class="table table-striped">
													<tbody>
														...
														<tr>
															<th scope="row"><input type="radio"  id="member_demo-1" class="radio country" name="country"  value="All" checked="">
															<label for="member_demo-1">Worldwide</label> </th>
															<th scope="row" id="count_all"><?php //echo $count = $this->demograph_model->demograph_data('All','All','All','All');?></th>
															<th scope="row" class="hidden-xs"><input id="member_demo-2" class="radio country" type="radio" name="country"  value="Pakistan">
															<label for="member_demo-2">Pakistan</label> </th>
															<th id="count_pakistan" scope="row" class="hidden-xs"><?php //echo $count = $this->demograph_model->demograph_data('All','Pakistan','All','All');?></th>
														</tr>
													</tbody>
													<tbody>
														<tr>
															<th scope="row"><input type="radio" id="member_demo-3" class="radio country" name="country"  value="India">
															<label for="member_demo-3"> India</label> </th>
															<th id="count_india"><?php //echo $count = $this->demograph_model->demograph_data('All','India','All','All');?></th>
															
															<th scope="row" class="hidden-xs"><input id="member_demo-4" class="radio country" type="radio" name="country"  value="Others">
															<label for="member_demo-4"> All Others</label> </th>
															<th scope="row" class="hidden-xs" id="count_others"><?php //echo $count = $this->demograph_model->demograph_data('All','Others','All','All');?></th>
														</tr>
													</tbody>
													<tbody>
														<tr>
															<th scope="row"><input type="radio" id="member_demo-5" class="radio country" name="country"  value="Australia">
																<label for="member_demo-5">Australia</label>
															</th>
															
															<th id="count_australia" scope="row"><?php //echo $count = $this->demograph_model->demograph_data('All','Australia','All','All');?></th>
															<th scope="row" class="hidden-xs"><input id="member_demo-6" class="radio country" type="radio" name="country"  value="United Kingdom">
															<label for="member_demo-6">UK </label></th>
															<th id="count_uk" scope="row" class="hidden-xs"><?php //echo $count = $this->demograph_model->demograph_data('All','United Kingdom','All','All');?></th>
														</tr>
													</tbody>
													
													<tbody>
														<tr>
															<th scope="row"><input type="radio" id="member_demo-7" class="radio country" name="country"  value="United States">
															<label for="member_demo-7">USA</label> </th>
															<th id="count_usa"><?php //echo $count = $this->demograph_model->demograph_data('All','United States','All','All');?></th>
															<th scope="row" class="hidden-xs"><input type="radio" id="member_demo-8"  class="radio" name="country"  value="Gulf">
															<label for="member_demo-8"> Middle East</label> </th>
															<th id="count_gulf" class="hidden-xs"><?php //echo $count = $this->demograph_model->demograph_data('All','Gulf','All','All');?></th>
														</tr>
														
													</tbody>
													<tbody>
														<tr>
															<th scope="row"><input type="radio" id="member_demo-10" class="radio country" name="country"   value="Canada">
															<label for="member_demo-10"> Canada</label> </th>
															<th id="count_canada"><?php //echo $count = $this->demograph_model->demograph_data('All','Canada','All','All');?></th>
														</tr>
													</tbody>
												</table>
											</div>
