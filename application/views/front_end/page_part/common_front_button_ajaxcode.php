<input type="hidden" id="matri_id_for_action" name="matri_id_for_action" value="" />
    ...
    <div id='myModal_ViewContactDetails' class='modal fade' role='dialog'>
    </div>
    <div id='myModal_ViewVideo' class='modal fade' role='dialog'>
    </div>
    ...
    <div id="myModal_email" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div id="respond_email_message"> </div>
                <div class="modal-body">
                    <form class="form-group" name="send_email_form" id="send_email_form" action="" method="post">
                        <span>Email Subject : </span>
                        <input type="text" placeholder="Email Subject" class="form-control input-border-modal" name="email_subject" id="email_subject"/>
                        <span>Email Content : </span>
                        <div class="ne-editor">
                            <div id="txtEditor"></div>
                        </div>
                        <textarea style="display:none" id="email_message" name="email_message"></textarea>
                        <div class="clearfix"></div>
                        <br/>
                        <div class="modal-footer">
                            <a class="btn btn-sm"  onClick="send_mail('sent')"><i class="fa fa-send"></i> Send</a>
    ...
    <div id="myModal_ignore" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    <div id="myModal_post_wall" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"><i class="fa fa-pencil"></i> Write something to send interest</h4>
                </div>
                <div class="modal-body">
                    <div class="xxl-16 xl-16 m-16 s-16 xs-16 l-16">
                        <textarea class="form-control" rows="6" placeholder="Write something to send interest"></textarea>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="modal-footer">
...
<div id="myModal_shortlist" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" id="shortlist_profile_header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16">
                    ...
                    <div id="shortlist_profile_alt" class="alert alert-danger" style="overflow:hidden;box-shadow:4px 4px 0 0 #ccc;">
            ...
            <div id="shortlist_button">
                <a class="btn btn-sm btn-warning" onClick="add_shortlist()"><i class="fa fa-ban"></i> Shortlist</a>
                          ...
                          <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <form name="send_message_form" id="send_message_form" action="" method="post" >
                                    <!-- <input style="padding:5px" type="text" placeholder="Subject" class="form-control input-border-modal" name="subject" id="subject" /> -->
									...
									<div class="clearfix"></div>
									<div class="modal-footer">
										<a class="btn btn-sm" id="send_message" onClick="send_message('sent')"><i class="fa fa-send"></i> Send</a>
										<a class="btn btn-sm btn-danger" id="send_message_cancel" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</a>
									</div>
                                </form>
                            </div>
...
<div id="myModal_shortlisted" class="modal fade" role="dialog" style="display: none;">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header" id="shortlisted_profile_header">
								...
								<div class="modal-footer margin-top-10">
                                 <div id="shortlisted_button">
									<a class="btn btn-sm btn-success" onClick="remove_shortlist()"><i class="fa fa-check"></i> UnShortlist</a>
								<a class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</a>
                                  </div>
...
<div id="myModal_block" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16">
                    ...
                    <div id="block_profile_alt" class="alert alert-danger" style="overflow:hidden;box-shadow:4px 4px 0 0 #ccc;">
                        <div class="xxl-2 xl-2 l-2 m-16 xs-16 s-16 tex-center">
                        <img src="<?php echo $base_url; ?>assets/front_end/images/icon/user-ban2.png" alt="" class="margin-right-10" />
                        </div>
                        <div class="xxl-13 xl-13 l-13 m-16 xs-16 s-16 xxl-margin-left-1 xl-margin-left-1 margin-top-10">
            ...
            <div class="modal-footer margin-top-10">
            <div id="block_button">
                <a class="btn btn-sm btn-warning" onClick="add_blocklist()"><i class="fa fa-ban"></i> Block</a>
                <a class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> No</a>
             </div>
 ...
 <div id="myModal_unblock" class="modal fade" role="dialog" style="display: none;">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal">×</button>
								...
								<div class="modal-footer margin-top-10">
                                 <div id="unblock_button">
									<a class="btn btn-sm btn-success" onClick="remove_blocklist()"><i class="fa fa-check"></i> Unblock</a>
								<a class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</a>
                                  </div>
...
<div id="myModal_sendinterest" class="modal fade" role="dialog">
		...
		?>
                    <div class="modal-body">
                        <div class="xxl-16 xl-16 l-16 s-16 m-16 xs-16 margin-top-10px-320px margin-top-10px-480px ne-mrg-top-10-768 margin-top-10px-999" id="is_block_member_exp" style="display:none;">
                        ...
                        <div id="form_express_intrest">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-sm" onClick="express_interest_sent()"><i class="fa fa-heart"></i> Send</a>
                                <a class="btn btn-sm btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</a>
                                 </div>
	...
	function remove_shortlist()
	{
		...
		$.ajax({
					...
					{ 	
						...
						if(data.status == 'success')
						{
							//$('#shortlisted_profile_header').hide();
...
<?php
	$this->common_model->js_extra_code_fr.="
		$(document).ready(function() {			
				$('#txtEditor').Editor(); 
				$('div.Editor-editor').html($('#email_message').val()); 
				$('div.Editor-editor').blur(function(){
					var cms_cont= $('div.Editor-editor').html();
					$('#email_message').val(cms_cont);
				});
