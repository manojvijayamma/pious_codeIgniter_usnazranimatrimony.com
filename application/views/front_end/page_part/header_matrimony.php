...
{
    $matri_seo_title='Matrimony';
    $matri_seo_description="One of India's best known brands and the world's largest matrimonial service was founded with a simple objective - to help people find happiness. The company pioneered online matrimonials in 1996 and continues to lead the exciting matrimony category.";
    $matri_seo_keywords='Mega Matrimony keywords';
    $matri_ogtitel='';
    $matri_ogimage='';
    $matri_ogdescrition='';
}
...
<html lang="en">
	<head>
		...
		<title><?php  if(isset($matri_seo_title) && $matri_seo_title !=''){ echo ucwords($matri_seo_title.'-Matrimony'); }elseif(isset($seo_title) && $seo_title !=''){ echo $seo_title; }else{ if(isset($page_title) && $page_title !=''){echo $page_title;} else { if(isset($config_data['website_title']) && $config_data['website_title'] !=''){ echo $config_data['website_title'];} } }?></title>
