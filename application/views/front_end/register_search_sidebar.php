<div class="xxl-16 xl-16 xs-16 m-16 s-16 l-16  bg-border margin-top-10px hidden-sm hidden-xs" style="margin-bottom: 30px;">
    ...
    <?php if(isset($is_login) && $is_login!=1){ ?>                   
        <div class="tab-pane fade <?php if(isset($is_login) && $is_login!=1){ ?>in active<?php } else {}?>" id="reg">
            ...
            <?php }?>
        <div class="tab-pane fade <?php if(isset($is_login) && $is_login!=1){ } else {?>in active<?php }?>" id="search">
            <div class=" row form-group  padding-lr-zero-320 padding-lr-zero-480 padding-lr-zero-xs">
            ...
            <?php
                ...
                <div class="xxl-16 xl-16 m-16 xs-16 s-16 l-16 padding-lr-zero">
                    ...
                    <div class="xxl-16 xl-16 m-12 s-16 l-12 xs-16 ne_font_12">
                        <div class="row">
                            <select data-placeholder="Select Catholic Community" id="search_religions" name="religion[]" class="chosen-select form-control" multiple >
