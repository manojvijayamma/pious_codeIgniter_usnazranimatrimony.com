        ...
        <div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-320 padding-lr-zero-480 padding-20-5-xs" style="padding:20px 20px;">
            <div class="xxl-4 xl-4 s-16 m-16 l-4 xs-16 ne_inbox_left_pan padding-lr-zero-320 padding-lr-zero-480 padding-lr-zero-xs hidden-xs">
                <div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
                    <a href="<?php echo $base_url; ?>messages/compose_msg" class="btn-compose-new-msg xxl-16 xl-16 l-16 m-16 s-16 xs-16 ne-cursor" onClick="cmpchkmsg();">
                ...
                <ul class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 bg-border margin-top-10px padding-lr-zero border-top">
                    <li class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
                        <a href="<?php echo $base_url; ?>messages/inbox" class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-999 ">
                    ...
                    <li class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
                        <a href="<?php echo $base_url; ?>messages/sent-msg" class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-999 ">
                            <div class="bold xxl-10 xl-10 s-10 m-10 xs-12 l-12 ne_font_14 ne_pad_tp_3px">
                    ...
                    <li class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
                        <a href="<?php echo $base_url; ?>messages/draft-msg" class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-999 ">
                            <div class="bold xxl-10 xl-10 s-10 m-10 xs-12 l-12 ne_font_14 ne_pad_tp_3px">
                    ...
                    <li class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
                        <a href="<?php echo $base_url; ?>messages/important-msg" class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-999 ">
                            <div class="bold xxl-10 xl-10 s-10 m-10 xs-12 l-12 ne_font_14 ne_pad_tp_3px">
                    ...
                    <li class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
                        <a href="<?php echo $base_url; ?>messages/trash-msg" class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-999 ">
                            <div class="bold xxl-10 xl-10 s-10 m-10 xs-12 l-12 ne_font_14 ne_pad_tp_3px">
            ...
            <div class="xxl-12 xl-12 l-12 xs-16 m-16 s-16 ne_inbox_right_pan padding-lr-zero-320 margin-top-10px-320px padding-lr-zero-480 margin-top-10px-480px  ne-mrg-top-10-768 bg-border border-top padding-20-5-xs">
                <h3 class="upgrade-heading margin-top-0px font-18 text-white text-center text-shadow-black" style="padding:5px;">
                    <i class="fa fa-envelope ne_mrg_ri8_10"></i>
                    Draft Box
                </h3>
                ...
                <div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 bg-offwhite ne-bdr-tpstrip-inbox ne_pad_tp_5px" style="background-image:-webkit-gradient(linear,left top,left bottom,from(#f5f5f5),to(#cfd1cf));border-radius:3px;border:1px solid #ddd;">
                    <div class="xxl-8 xl-8 xs-16 s-16 m-16 l-9 margin-top-5-xs">
                        <div class="row">
                            ...
                            <a class="btn btn-warning ne_msg_tp_strip text-white" data-toggle="tooltip" data-placement="left" title="Important" >
                                <i class="fa fa-star-o"></i>
                            </a>
                            <a class="btn btn-primary ne_msg_tp_strip text-white" data-toggle="tooltip" data-placement="left" title="Refresh" >
                                <i class="fa fa-refresh"></i>
                            </a>
                            <a class="btn btn-danger ne_msg_tp_strip text-white" data-toggle="tooltip" data-placement="left" title="Reply" >
                                <i class="fa fa-reply"></i>
                            </a>
                            <a class="btn btn-success ne_msg_tp_strip text-white" data-toggle="tooltip" data-placement="left" title="Forward" >
                    ...
                    <div class="xxl-8 xl-8 m-16 xs-16 s-16 l-7 margin-top-10px-320px margin-top-10px-480px">
                        <div class="row">
                            <div class="xxl-5 xxl-margin-left-1 xs-6 s-6">
                            </div>
