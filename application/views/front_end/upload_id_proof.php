		...
		<div class="st-tabs">
			<div class="xxl-12 xl-12 l-12 xs-16 m-16 s-16 ne_inbox_right_pan padding-lr-zero-320 margin-top-10px-320px padding-lr-zero-480 margin-top-10px-480px ne-mrg-top-10-768 padding-0-5-xs">
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#h-upload" aria-controls="h-upload" role="tab" data-toggle="tab"><i class="fa fa-upload font-16 margin-right-5"></i> Upload <span class="hidden-xs">ID Proof</span></a></li>
				</ul>
							...
							<div class="xxl-16 xl-16 m-16 s-16 l-16 xs-16">
								<div class="row">
									<h2 class="font-18 upgrade-heading  center-text margin-top-0px" style="text-shadow:2px 2px 1px rgba(203, 203, 203, 1);padding:5px 0;">
										<img src="<?php echo $base_url; ?>assets/front_end/images/icon/astrology.png" alt=""/> Upload ID Proof
									</h2>			
								</div>
							</div>
									...
									<div class="xxl-16 xl-16 xs-16 m-6 l-16 s-16">
										<form method="post" name="id_proof_photo_form" id="id_proof_photo_form" enctype="multipart/form-data" action="<?php echo $base_url; ?>upload/upload-id-proof-photo" >
											...
											<a class="fileUpload btn btn-sm active font-15 bold text-white" style="background:#F58220;box-shadow:3px 3px 0 0 #e2e2e2;"><img src="<?php echo $base_url;?>assets/front_end/images/add-photo-comp.gif" width="23" height="30"  alt="" style="padding-top:6px;"> Upload from My Computer 
												<input type="file" id="id_proof" name="id_proof"  class="upload xxl-16 xs-16 m-16 xs-16 padding-top-10px padding-bottom-10px" style="padding:5px;cursor:pointer;height:100%;" />
										...
										<div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16">
											<center>
                                                ...
                                                <?php if(isset($id_proof) &&  $id_proof!='')
													{?>
													<img id="blah" src="<?php echo $base_url.$path_id_proof.$id_proof;?>" class="blah border img-responsive" alt="your image" style="box-shadow: 0 5px 11px 0 rgba(0,0,0,.18), 0 4px 15px 0 rgba(0,0,0,.15);margin:12px 12px;" />
													<?php }else{
													?>
													<div id="no_id_proof_msg"> <h4 class="text-darkgrey">No id proof Image available</h4></div>
												...
												?>	
												<div onClick="set_id_proof_photo_del()" id="photo_delete_btn" style="display:<?php echo $display_del; ?>;"><a href="javascript:;" data-toggle="modal" data-target="#myModal_delete" class="text-red"><i class="fa fa-trash margin-right-10 font-15"></i>Delete ID Proof Photo</a></div>
											</center>
										</div>
									</div>
								</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><img src="<?php echo $base_url; ?>assets/front_end/images/icon/alert.png" alt="" class="" /> Delete This Saved ID Proof Photo</h4>
					</div>
					...
					<div class="modal-footer margin-top-10">
						<div id="delete_button">
							<a class="btn btn-sm btn-success" onClick="delete_id_proof_photo()"><i class="fa fa-check" ></i> Yes</a>
