				...
				<div class="fb-profile-block"> 
					...
					<div class="profile-img">
						<?php
							...
							?>
							<!--<a href="javascript:;" onClick="newWindow('<?php echo base_url();?>search/photo-password/<?php echo $user_data['matri_id']; ?>', '', '650', '420')" >
								<img src="<?php echo $photopassword_image; ?>" class="cursor img-thumbnail text-center" alt="" style=" max-height: 158px; max-width: 158px;min-height: 158px; min-width: 158px;">
							</a>-->
							...
							<div class="fb-profile-block-menu">
								<div class="block-menu">
									<ul>
										...
										<!--<li>
											<a data-toggle="modal" data-target="#myModal_email" class="btn-more" onClick="get_member_matri_id_for_email('<?php echo $email;?>')" ><span class="write_online_txt"><span class="sticker_1"></span>Send Email</span></a>
										</li>-->
										<li>
										...
										<li>
											...
											<div id ="add_shortlist_<?php echo $user_data['matri_id'];?>" style="display:<?php if($is_short_list != 0){ echo 'none';} ?>">
												...
												<a data-toggle="modal" data-target="#myModal_shortlist" class="btn-more text-center" onClick="add_shortlist_matri_id('<?php echo $user_data['matri_id'];?>')">
											...
											<!--<a data-toggle="modal" data-target="#myModal_ignore" class="btn-more text-center"><span class="write_online_txt"><i class="fa fa-user-times"></i> Igonre</span></a>-->
										</li>
										<li>
											<?php 
					...
					<?php   } 
								...
								<div class="xxl-4 xl-4 l-4 m-8 s-16 xs-16">
									...
									<div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16">
										...
										<!--<a href="#" class="btn-sm btn no-shadow m-7 s-7 xs-7" title="May be" style="background:#83E1ED;">May be</a>-->
																	...
																	<p class="margin-top-5"><span class="basic-img_4"></span>Mother Tongue : <?php 
																		...
																		<p class="margin-top-5"><span class="basic-img_5"></span>Education : 
																			<?php 
																				...
																				<p class="margin-top-5"><span class="basic-img_6"></span>Designation : 
																				<?php if(isset($user_data['occupation_name']) && $user_data['occupation_name'] !=''){ echo $user_data['occupation_name'];}else{echo $this->common_model->display_data_na($user_data['occupation_name']);}?></p>
									...
									<div class="xxl-16 xl-16 m-16 s-16 xs-16 l-16 bg-border margin-top-15px padding-0-5-xs" style="padding-top:0px;">
										...
										<div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero">
											...
											<!-- <div>
												...
												<div class="detail_section">
													<?php 
														...
														?>
														<div class="profile_manglik" >
															<span class="info_icon"></span>
															<a data-toggle="modal" href="#myModal" class=" ">View Horoscope</a>
																	...
																	<div class="modal-content">
																		<div class="modal-body" style="padding: 0px 10px 10px 10px !important;">
																			<div style="text-align: right;">
																				<div class="btn-group" >
																					<button class=" " style="background: none!important; border: none; color: #000;" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> </button>
																				</div>
																			</div>
																			<img src="<?php echo $horoscope;?>" style="width: 100%;">
																		</div>
																	</div>
																</div>
															</div>
														...
														<?php }else{ ?>
														<div class="profile_manglik" >
															<span class="info_icon"></span><span class="basic_info_content">Horoscope : N/A</span>
														</div>
													<?php } ?>
													<div class="profile_manglik" >
														<span class="info_icon"></span><span class="basic_info_content">Manglik : <?php if(isset($user_data['manglik']) && $user_data['manglik'] !=''){ echo $user_data['manglik'];}else{echo $this->common_model->display_data_na($user_data['manglik']);}?></span>
													</div>
													<div class="profile_manglik" >
														<span class="info_icon"></span><span class="basic_info_content">Star : <?php if(isset($user_data['star']) && $user_data['star'] !=''){ echo $user_data['star'];}else{echo $this->common_model->display_data_na($user_data['star']);}?></span>
													</div>
													<div class="profile_manglik">
														<span class="info_icon"></span><span class="basic_info_content">Gothra  : <?php if(isset($user_data['gothra']) && $user_data['gothra'] !=''){ echo $user_data['gothra'];}else{echo $this->common_model->display_data_na($user_data['gothra']);}?></span>
													</div>
													<div class="profile_manglik">
											...
											<div>
												...
												<div class="detail_section"> <?php if(isset($user_data['family_details']) && $user_data['family_details'] !=''){ echo $user_data['family_details'];}else{echo $this->common_model->display_data_na($user_data['family_details']);}?></div>
											</div>
											...
											<div class="info_container xxl-16 xl-16 l-16 m-16 s-16 xs-16">
												<div class="info_wrap xxl-13 xl-13 l-13 m-16 s-16 xs-16">
													...
													<?php if(isset($user_data['part_mother_tongue']) && $user_data['part_mother_tongue'] !='')
														...
														<!--<a class="underline hook5 in" data-toggle="collapse" href=".hook5" aria-expanded="false" >more<span class="more_down_arrow" ></span></a>--></span>
										...
										<div class="info_container xxl-16 xl-16 l-16 m-16 s-16 xs-16">
											<div class="info_wrap xxl-13 xl-13 l-13 m-16 s-16 xs-16">
												...
												<?php if(isset($user_data['part_country_living']) && $user_data['part_country_living'] !='')
													...
													<!--<a class="underline hook4 in" data-toggle="collapse" href=".hook4" aria-expanded="false" >more<span class="more_down_arrow" ></span></a>--></span>
									...
									<div class="info_container xxl-16 xl-16 l-16 m-16 s-16 xs-16">
										<div class="info_wrap xxl-13 xl-13 l-13 m-16 s-16 xs-16">
											...
											<?php if(isset($user_data['part_education']) && $user_data['part_education'] !='')
												...
												<!--<a class="underline hook3 in" data-toggle="collapse" href=".hook3" aria-expanded="false" >more<span class="more_down_arrow" ></span></a>--></span>
								...
								<div class="info_container xxl-16 xl-16 l-16 m-16 s-16 xs-16">
									<div class="info_wrap xxl-13 xl-13 l-13 m-16 s-16 xs-16">
										...
										<?php if(isset($user_data['part_occupation']) && $user_data['part_occupation'] !='')
											...
											<!--<a class="underline hook2 in" data-toggle="collapse" href=".hook2" aria-expanded="false" >more<span class="more_down_arrow" ></span></a>--></span>
							...
							<div class="info_container xxl-16 xl-16 l-16 m-16 s-16 xs-16">
								<div class="info_wrap xxl-13 xl-13 l-13 m-16 s-16 xs-16">
									...
									<?php if(isset($user_data['part_designation']) && $user_data['part_designation'] !='')
										...
										<!--<a class="underline hook1 in" data-toggle="collapse" href=".hook1" aria-expanded="false"> more<span class="more_down_arrow" ></span></a>--></span>
