	...
	<div id="slider" class="owl-carousel owl-theme slider hp-3">
		<?php
			...
			if(isset($home_banner) && $home_banner !='' && is_array($home_banner) && count($home_banner) > 0)
			{
				...
				?> 
				<div class="item slider-shade"><img data-src="<?php echo $banner_url; ?>" class="lazyload banner-home-1" src="assets/front_end/images/slider/xyz.jpg" alt=" " style="width:100%;height:690px;"></div>
				<?php
				}
			}
			else
			{
			?>
            <div class="item slider-shade"><img data-src="<?php echo $base_url; ?>assets/front_end/images/slider/slider-15.jpg" src="assets/front_end/images/slider/xyz.jpg" class="lazyload banner-home-1" alt="Wedding"></div>
            <?php
			}
		?>
	</div>
...
<div class="container" style="background:#fff;">
	<div class="container margin-top-20 padding-0-5-xs">
		...
		<div class="col-md-4 col-sm-12 col-xs-12 margin-top-30 padding-0-5-xs">
			<a target="_blank" href="<?php if(isset($config_data['android_app_link']) && $config_data['android_app_link'] !='') {echo $config_data['android_app_link'];} ?>"><img data-src="<?php echo $base_url; ?>assets/front_end/images/google-play.gif" class="img-responsive lazyload" src="assets/front_end/images/xyz-t.gif" alt="google-play" title="google-play" /></a>
			<a target="_blank"  href="<?php if(isset($config_data['ios_app_link']) && $config_data['ios_app_link'] !='') {echo $config_data['ios_app_link'];} ?>"><img data-src="<?php echo $base_url; ?>assets/front_end/images/app-store.gif" class="img-responsive lazyload margin-top-30" alt="app-store" src="assets/front_end/images/xyz-t.gif" title="app-store" /></a>
		</div>
	</div>
</div>
