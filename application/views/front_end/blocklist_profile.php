<div class="container margin-top-20 padding-0-5-xs">
	<div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-320 padding-lr-zero-480 padding-lr-zero-768 padding-lr-zero margin-top-20">
		<div class="xxl-4 xl-4 xs-16 m-16 s-16 l-5">
			 <?php $this->load->view('front_end/my_profile_sidebar'); ?>
		</div>
		
		<div class="xxl-12 xl-12 l-11 xs-16 m-16 s-16 padding-lr-zero-320 margin-top-10px-320px padding-lr-zero-480 margin-top-10px-480px ne-mrg-top-10-768 padding-lr-zero-xs">
			<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 bg-border padding-lr-zero" style="padding:4px;position:relative;">
				<div class="xxl-16 xl-16 m-16 s-16 l-16 xs-16 " style="padding:0px 4px;">
					<h3 class="upgrade-heading text-center font-18 text-white xxl-16 xl-16 l-16 s-16 m-16 font-16 margin-top-0px margin-bottom-0px padding-lr-zero-320" style="color:rgba(94,94,94,1.00);">
						<i class="fa fa-user-times ne_mrg_ri8_10"></i> Blocked Profile
					</h3>
				</div>
				<!------- for search result ----->
