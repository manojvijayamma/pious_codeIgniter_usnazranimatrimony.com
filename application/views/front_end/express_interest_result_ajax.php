        ...
        <div class="xs-16 xl-16 xxl-16 m-16 s-16 ne_result  padding-lr-zero margin-bottom-10px margin-top-20px border-top">
            ...
            <?php
				...
				if (isset($all_sent_ei['photo1']) && $all_sent_ei['photo1'] != '' && $all_sent_ei['photo1_approve'] == 'APPROVED' && file_exists($path_photos . $all_sent_ei['photo1']) && $all_sent_ei['photo_password'] != '' && $all_sent_ei['photo_protect'] != 'No' && $all_sent_ei['photo_view_status'] == 0) {
					...
					<!--<a href="javascript:;" onClick="newWindow('<?php echo base_url(); ?>search/photo-password/<?php echo $all_sent_ei['matri_id']; ?>', '', '650', '420')" >
						<img src="<?php echo $photopassword_image; ?>" class="xxl-16 xs-16 xl-16 l-16 m-16 s-16 img-responsive success-story-img text-align-center" title="<?php echo $comm_model->display_data_na($all_sent_ei['username']); ?>" alt="<?php echo $comm_model->display_data_na($all_sent_ei['matri_id']); ?>" style="width:120px; height:120px !important;" >
					</a>-->
                            ...
                            <div class="row">
                                ...
                                <div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 ne_font_12 margin-bottom-6px">
                                    <div class="row">
                                        ...
                                        <div class="xxl-9 xl-9 l-9 m-9 s-9 ne-word-wrap">
                                            <div class="row">
                                    :  <?php echo $this->common_model->display_data_na($all_sent_ei['religion_name']);?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
