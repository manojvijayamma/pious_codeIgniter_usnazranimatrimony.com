...
class Lead_generation_model extends CI_Model {
	...
	function lead_gen_list($status ='ALL', $page=1, $personal_where='')
	{
		...
		$ele_array = array(
			...
			'interest'=>array('is_required'=>'required','type'=>'dropdown','value_arr'=>array('New'=>'New Register','Green'=>'Green','Blue'=>'Blue','Orange'=>'Orange','Red'=>'Red','Final Client'=>'Final Client','Call'=>'Incoming Call')),
		);
		...
		{
			 $edit_btn_arr = array('url'=>'lead-generation/lead-generation-list/edit-data/#id#','class'=>'info','label'=>'Edit Profile','target'=>'_blank');
	...
	function filter_form_array()
	{
		...
		$ele_array = array(
			...
			'importance'=>array('display_in'=>'2','type'=>'dropdown','value_arr'=>array('New'=>'New Register','Green'=>'Green','Blue'=>'Blue','Orange'=>'Orange','Red'=>'Red','Final Client'=>'Final Client','Call'=>'Incoming Call')),
