...
class Register_model extends CI_Model {
...

		{
...

			{
...

				{
					...
					if(isset($mobile_data) && is_array($mobile_data) && count($mobile_data)>0)
					...
					if(isset($email_data) && is_array($email_data) && count($email_data)>0)
...

				{
...

					{
...

						{
							...
							$data1['errmessage'] =  "Your profile has been updated, please complete next step to complete your profile, please wait while we are redirecting to next step";
...

						{
							...
							$data1['errmessage'] =  "Your profile has been created, please complete next step to complete your profile, please wait while we are redirecting to next step";
...

	{
		...
		{	
			...
			{
				$data1['status'] = isset($data1['status']) ? $data1['status'] : "success";
				$data1['errmessage'] = isset($data1['errmessage']) ? $data1['errmessage'] : "Your profile has been added successfully";
				$data['data'] = json_encode($data1);
