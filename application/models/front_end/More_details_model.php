...
class More_details_model extends CI_Model{
	...
	function page_name_list($page_name,$page=1,$limit=0)
	{
		...
		$data_cnt = $this->common_model->get_count_data_manual("matrimony_data",$where_arra,2,'id,matrimony_name','id DESC');
	...
	function community_name_list($search_type,$page=1,$limit=10)
	{
		...
		$matrimony_name_data = $this->common_model->get_count_data_manual("matrimony_data",$where_arra,2,'matrimony_name','id DESC',$page,$limit);
