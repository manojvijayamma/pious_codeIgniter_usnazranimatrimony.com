...
<div class="board-inner">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li class="payment-tabs ">
                                ...
                                <li class="payment-tabs active"><a href="#settings" data-toggle="tooltip" title="" data-original-title="Success payment">
            ...
            <div class="xxl-10 xl-10 xs-16 s-16 m-16 l-16 margin-top-20px">
                <div class="alert" style="background:#6AC259;overflow:hidden;box-shadow:4px 4px 0 0 #ccc;margin-bottom:10px;">
                    ...
                    <div class="xxl-16 m-16 s-16 xs-16 margin-top-10px">
                        ...
                        <div class="xxl-13 xl-13 l-13 m-16 xs-16 s-16 xxl-margin-left-1 xl-margin-left-1 margin-top-20">
                            <h4 class="small text-white font-16 text-shadow">Your Payment Successfully Done ...!!!</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="alert alert-info margin-top-10" style="overflow:hidden;box-shadow:4px 4px 0 0 #ccc;margin-bottom:0px;">
                    ...
                    <div class="xxl-13 xl-13 l-13 m-16 xs-16 s-16 xxl-margin-left-1 xl-margin-left-1 margin-top-10">
                        <h4 class="text-shadow-black">Please view your profile</h4>
                        <p class="small">Now enjoy your matrimonial account.</p>
                    </div>
                    <center><a href="<?php echo $base_url; ?>my-profile" style="box-shadow:3px 3px 0 0 #ccc; display: inline-block;" class="text-shadow btn btn-info margin-top-10 btn-sm font-15 bold"> View Profile <i class="fa fa-chevron-right"></i></a></center>
                </div>
                <div class="clearfix"></div>
            </div>
