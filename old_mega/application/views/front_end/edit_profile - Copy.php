<!------------------<div class="container">----Start------------------------------>	
    ...
    <div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 padding-lr-zero-320 padding-lr-zero-480 padding-lr-zero-768 margin-top-20 padding-0-5-xs" style="padding-right:0px;">
        ...
        <div class="xs-16 s-16 xl-12 xxl-12 m-12 l-12 padding-lr-zero-320 padding-lr-zero-480 padding-0-5-xs">
				<div class="ne_pad_btm_10px padding-lr-zero-320 padding-lr-zero-480">
                    ...
                    <div id="part-education-detail" class="margin-top-20 bg-border" style="padding-top:0px;">
                        <div class="row padding-0-xs" data-toggle="collapse" href="#ne_lft_pan_list10" role="" aria-expanded="false" aria-controls="ne_lft_pan_list1" onclick="change_img('10_profile')" style="padding:4px 0px;">
                            <h3 class="font-16-bold-arial title-bg-noradius margin-top-5-xs" style="margin-top:0px;">
                                <a href="#" class="text-white">
                                    <i class="fa fa-university ne_mrg_ri8_10"></i>Edit Education / Profession Preferences
	...
	<div class="padding-lr-zero-320 padding-lr-zero-480 padding-lr-zero-768">
		<div class="">
			<div class="xs-16 s-16 xl-12 xxl-12 m-11 l-12 padding-lr-zero-320 padding-lr-zero-480 padding-0-5-xs">
				<div class="ne_pad_btm_10px padding-lr-zero-320 padding-lr-zero-480">
					<div class="xxl-16 xl-16 s-16 m-16 l-16 xs-16 ne-bdr-btm-lgt-grey ne_pad_btm_10px bg-border margin-top-20">
						<div class="">
							<a href="javascript:;" onClick="scroll_to_div('basic-detail')" class="xxl-5 xl-5 l-5 xs-16 s-16 m-16 btn font-weight-bold pull-left text-white margin-right-10 margin-bottom-0px margin-top-0px">
		...
		<div class="xxl-4 xl-4 m-4 l-4 xs-16 s-16 bg-border hidden-xs margin-top-20" style="padding-top:0px;padding-bottom:0px;">
				<div class="row" style="padding:4px;">
					<h3 class="upgrade-heading" style="margin:0px;">
						<img src="<?php echo $base_url; ?>assets/front_end/images/icon/link.png" class="ne_mrg_ri8_10 font-12" alt=""/>
						<span class="ne_mrg_ri8_10">Useful Links</span>
					</h3>
					<div class="collapse in"><!-- id="ne_lft_pan_list1 -->
		...
		<div class="xxl-4 xl-4 m-4 l-4 xs-16 s-16 bg-border margin-top-20px padding-0-5-xs hidden-xs" style="padding-top:0px;padding-bottom:0px;">
				<div class="row" style="padding: 4px 13px;">
					<div class="upgrade-heading"><img src="<?php echo $base_url; ?>assets/front_end/images/icon/users.png" class="ne_mrg_ri8_10 font-12" alt=""> View Similar Profile 
						<div class="controls pull-right">
							<a class="nxt_active" href="#quote-carousel" data-slide="next"></a>
							<a class="prv_active" href="#quote-carousel" data-slide="prev"></a>
						</div>
					</div>
				</div>
													...
													<div class="owl-carousel xxl-16 padding-lr-zero">
														<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 featured-profile padding-lr-zero">
															...
															<div class="xxl-10 xl-10 m-10 l-10 s-10 xs-10 padding-right-0">
																<div class="row">
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16">
																		<a href="#" class="xxl-16 xl-16 l-16 s-16 m-16 xs-16 font padding-lr-zero text_slider">Sneha Sharma</a>
																	</div>
														...
														<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 featured-profile padding-lr-zero">
															...
															<div class="xxl-10 xl-10 m-10 l-10 s-10 xs-10 padding-right-0">
																<div class="row">
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16">
																		<a href="memberFullProfile?user_id=NE1" class="font xxl-16 xl-16 l-16 s-16 m-16 xs-16 padding-lr-zero text_slider">Hemangi Sharma</a>
																	</div>
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16 ne_font_12">
														...
														<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 featured-profile padding-lr-zero" style="border-bottom:0px;">
															...
															<div class="xxl-10 xl-10 m-10 l-10 s-10 xs-10 padding-right-0">
																<div class="row">
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16">
																		<a href="memberFullProfile?user_id=NE1" class="font xxl-16 xl-16 l-16 s-16 m-16 xs-16 padding-lr-zero text_slider">Vaishali Patel</a>
																	</div>
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16 ne_font_12">
													...
													<div class="owl-carousel xxl-16 padding-lr-zero">
														<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 featured-profile padding-lr-zero">
															...
															<div class="xxl-10 xl-10 m-10 l-10 s-10 xs-10 padding-right-0">
																<div class="row">
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16">
																		<a href="#" class="xxl-16 xl-16 l-16 s-16 m-16 xs-16 font padding-lr-zero text_slider">Ritu Shah</a>
																	</div>
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16 ne_font_12">
														...
														<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 featured-profile padding-lr-zero">
															...
															<div class="xxl-10 xl-10 m-10 l-10 s-10 xs-10 padding-right-0">
																<div class="row">
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16">
																		<a href="memberFullProfile?user_id=NE1" class="font xxl-16 xl-16 l-16 s-16 m-16 xs-16 padding-lr-zero text_slider">Meena Agrawal</a>
																	</div>
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16 ne_font_12">
														...
														<div class="xxl-16 xl-16 l-16 m-16 xs-16 s-16 featured-profile padding-lr-zero" style="border-bottom:0px;">
															...
															<div class="xxl-10 xl-10 m-10 l-10 s-10 xs-10 padding-right-0">
																<div class="row">
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16">
																		<a href="memberFullProfile?user_id=NE1" class="font xxl-16 xl-16 l-16 s-16 m-16 xs-16 padding-lr-zero text_slider">Reena Maheta</a>
																	</div>
																	<div class="xxl-16 xl-16 m-16 xs-16 l-16 s-16 ne_font_12">
				...
				<div class="row" style="padding:4px;">
					<div class="upgrade-heading margin-top-5"> 
						<a class="view_all underline text_slider">View All <img src="<?php echo $base_url; ?>assets/front_end/images/icon/right-gray-arrow.png" alt="right-gray-arrow" /></a>
					</div>
				</div>
			</div>
								
			<div class="xxl-4 xl-4 m-4 l-4 xs-16 s-16 bg-border margin-bottom-10px margin-top-20px hidden-xs" style="padding-top:0px;padding-bottom:0px;">
				<div class="xxl-16 xl-16 l-16 m-16 s-16 xs-16 bg-white" style="box-shadow: none;">
					<div class="row" style="padding:4px;">
						<h3 class="upgrade-heading row" style="margin:0px;">
							<img src="<?php echo $base_url; ?>assets/front_end/images/icon/user-search.png" class="ne_mrg_ri8_10 ne_font_12" alt="" />
							<span class="ne_mrg_ri8_10">Quick search</span>
							
						</h3>
						<div class="xxl-16 xl-16 m-16 s-16 l-16xs-16 ne_myhome_save_search">
							<div class="row">
								<form class="xxl-16 xl-16 m-16 xs-16 l-16 s-16 ne_font_14" method="post" action="search_result" id="ne_lft_pan_list">
									<div class="row">
										...
										<div class="xxl-16 xl-16 m-16 xs-16 s-16 l-16 padding-lr-zero">
											...
											<a  class="btn btn-sm text-white pull-right">Search</a>
											</div>  
											<div class="clearfix"></div>
										</div> 
									</div>
						...
						<div class="clearfix"></div>
						<div class="row margin-top-10" style="border-top:1px solid #ddd;">
           	...
           	<div class="xxl-4 xl-4 xs-16 m-16 s-16 l-5 margin-bottom-15px margin-top-5px hidden-xs hidden-sm" style="padding:4px;">
            ...
            <div class="xxl-4 xl-4 xs-16 m-16 s-16 l-5 margin-bottom-15px margin-top-30px hidden-xs" style="padding:4px;">
