...
class My_profile extends CI_Controller {
	...
	public function index()
	{
		...
		$this->common_model->extra_css_fr= array('css/mdb.min.css','css/chosen.css','css/bootstrap-touch-slider.css','css/hover-img.css','css/BootSideMenu.css','css/chosen.css');
		$this->common_model->extra_js_fr= array('js/chosen.jquery.js','js/BootSideMenu.js','js/chosen.jquery.js','js/jquery.validate.min.js','js/photo_protect_js.js');
	...
	public function save_profile($step ='basic-detail')
	{
		...
		{		
			redirect($this->base_url.'my-profile/edit-profile');
		}
	}
	...
	public function common_function_profile($file_name='')
	{
		...
		{	
			$this->common_model->display_top_menu_perm ='No';
			$this->common_model->extra_css_fr= array('css/mdb.min.css','css/hover-img.css','css/chosen.css','css/bootstrap-touch-slider.css','css/BootSideMenu.css');
			$this->common_model->extra_js_fr= array('js/chosen.jquery.js','js/BootSideMenu.js','js/photo_protect_js.js');
			$this->common_model->front_load_header();
	...
	{	
		$this->data['page_name'] = 'I Viewed Profiles';
