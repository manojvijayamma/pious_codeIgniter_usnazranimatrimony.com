...
function clear_refine(class_reset)
{
	...
	else 
	{
		...
		if(class_reset =='religion')
		{
			...
			$('#list_disp_caste').html('<li class="xxl-16 xl-16 xs-16 s-16 m-16 l-16 padding-lr-zero"><span class="xxl-12 xl-12 xs-12 s-12 m-12 l-12 label-search">First Select Community</span></li>');
		}
